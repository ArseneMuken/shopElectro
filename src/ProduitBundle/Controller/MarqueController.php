...
use ProduitBundle\Entity\Marque;
...
class MarqueController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $marques = $em->getRepository('ProduitBundle:Marque')->findAll();
    ...
    {
        $marque = new Marque();
        $form = $this->createForm('ProduitBundle\Form\MarqueType', $marque);
    ...
    {
        $deleteForm = $this->createDeleteForm($marque);
        $editForm = $this->createForm('ProduitBundle\Form\MarqueType', $marque);
